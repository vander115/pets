<?php
     ...
     if(isset($_POST['desc_pet']) || isset($_POST['nome_pet']) || isset($_POST['tipo_pet']) || isset($_POST['raca_pet']) || isset($_FILES['img_pet']) || isset($_POST['tam_pet']) || isset($_POST['peso_pet']) || isset($_POST['idade_pet'])){
         ...
         } else if(strlen($_POST['tam_pet']) == 0){
            echo '<script>alert("Informe o tamanho do Animal!")</script>';
        } else if(strlen($_POST['desc_pet']) == 0){
            echo '<script>alert("Faça a descrição do Animal!")</script>';
        } else {
             $img = $_FILES['img_pet'];
             if ($img['error']) {
                 die('
             ...
             $sql = " INSERT INTO tb_animal_adocao VALUES (NULL, '$desc_pet', '$nome_pet', '$tipo_pet', '$raca_pet', '$tam_pet', '$peso_pet', '$idade_pet', '$path_banco', '$path');";
