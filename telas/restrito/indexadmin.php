...
">
	...
	<!-- Modal Trigger -->
	<br>
	<div class="titulo"><h4>Painel do Administrador</h4></div>
	<div class="fullcont">
	<?php 
		...
		<div class="medcontadm">
			...
			<li>
				  <div class="collapsible-header"><i style="color: #311b92;" class="material-icons">add_box</i><label>Cadrastar Produto</label></div>
				  <div class="collapsible-body">
							<form enctype="multipart/form-data" method="POST" action="cadrastar_produto.php">
								<div class="form-field">
									<label for="desc">Descrição*</label>
									<div class="input-field">
										<textarea id="desc" class="materialize-textarea" data-length="120" name="desc_prod"></textarea>
									</div>
								</div>
								<div class="cadprod">
									<div class="form-duo">
										<label for="preco">Preço(R$)*</label>
										<input type="text" onkeypress="return onlynumber();" name="preco_prod">
									</div>
										<div class="form-duo">
											<label for="descont">Tipo*</label>
								...
								<div class="form-field">
									...
									<input type="text" name="qtd_prod" id="" onkeypress="return onlynumber();">
								</div>
								<div class="form-field">
									<br>
								<div class="form-field">
