...
">
		...
		<nav>
			<div class="nav-wrapper">
				...
				<ul id="navbar-items" class="right hide-on-med-and-down">
					...
					<li><a href="galeria.php" class="active amber-text text-darken-4">Galeria</a></li>
	...
	<ul id="mobile-navbar" class="sidenav">
		...
		<li><div class="collapsible-header active"><a href="galeria.php" class="amber-text text-darken-4">Galeria</a></div></li>
		<li><div class="collapsible-header"><a href="#" class="amber-text text-darken-4">Sobre Nós</a></div></li>
	</ul>
	
	<div class="container-galeria">
		<div class="item-galeria w-2 h-2">
			<img src="../src/img/galery/dog1.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Cachorro 1
			</span>
		</div>
		<div class="item-galeria w-2 h-1">
			<img src="../src/img/galery/dog2.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Cachorro 2
			</span>
		</div>
		<div class="item-galeria w-1 h-2">
			<img src="../src/img/galery/dog3.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Cachorro 3
			</span>
		</div>
		<div class="item-galeria w-1 h-1">
			<img src="../src/img/galery/cat1.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Gato 1
			</span>
		</div>
		<div class="item-galeria w-2 h-2">
			<img src="../src/img/galery/cat2.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Gato 2
			</span>
		</div>
		<div class="item-galeria w-1 h-2">
			<img src="../src/img/galery/cat3.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Gato 3
			</span>
		</div>
		<div class="item-galeria w-1 h-1">
			<img src="../src/img/galery/bird1.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Pássaro 1
			</span>
		</div>
		<div class="item-galeria w-1 h-1">
			<img src="../src/img/galery/bird2.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Pássaro 2
			</span>
		</div>
		<div class="item-galeria w-1 h-1">
			<img src="../src/img/galery/bird3.jpg" class="img-galeria responsive-img" alt="">
			<span class="title-galeria">
				Pássaro 3
			</span>
		</div>
